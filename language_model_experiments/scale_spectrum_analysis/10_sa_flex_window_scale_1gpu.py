...
def main():
    ...
    # Window schedule (CLI fallback; args.json overrides if present)
    ...
    print(f"Window schedule: min={wmin}, max={wmax}, warmup_steps={wwarm} (args.json overrides CLI when present)")
