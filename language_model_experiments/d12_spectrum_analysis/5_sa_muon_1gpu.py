...
# =============================================================================
# Model Definitions (Matches 5_muon.py)
# =============================================================================
...
def apply_rotary_emb(x: torch.Tensor, cos: torch.Tensor, sin: torch.Tensor) -> torch.Tensor:
    ...
    x1 = x[..., :d]
    x2 = x[..., d:]
    # Match 5_muon.py (Standard Rotation)
    y1 = x1 * cos - x2 * sin
    y2 = x1 * sin + x2 * cos
...
def main():
    parser = argparse.ArgumentParser(description="GPT-2 Muon Spectrum Analysis")
    ...
    # Match checkpoint pattern from 5_muon.py (often checkpoint_stepXXXXXX.pt)
    ckpt_paths = sorted(
