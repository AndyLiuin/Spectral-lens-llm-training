...
#SBATCH --job-name=sweep_16
#SBATCH --output=logs/sweep_16_%A.out
#SBATCH --error=logs/sweep_16_%A.err
...
# Configuration
# ----------------------------
PY_SCRIPT="16_fp8lmhead_sweep.py"
OUT_DIR="lr_sweep/16_fp8lmhead"
...
echo "=========================================="
echo "Starting ASHA Sweep: 16_fp8lmhead"
echo "=========================================="
