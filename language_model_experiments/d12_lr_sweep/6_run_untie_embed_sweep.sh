...
#SBATCH --job-name=sweep_06
#SBATCH --output=logs/sweep_06_%A.out
#SBATCH --error=logs/sweep_06_%A.err
...
# Configuration
# ----------------------------
PY_SCRIPT="6_untie_embed_sweep.py"
OUT_DIR="lr_sweep/6_untie_embed"
...
echo "=========================================="
echo "Starting ASHA Sweep: 6_untie_embed (Untied Embeddings, No Value Mix)"
echo "=========================================="
