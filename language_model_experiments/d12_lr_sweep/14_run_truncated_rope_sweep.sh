...
#SBATCH --job-name=sweep_14
#SBATCH --output=logs/sweep_14_%A.out
#SBATCH --error=logs/sweep_14_%A.err
...
# Configuration
# ----------------------------
PY_SCRIPT="14_truncated_rope_sweep.py"
OUT_DIR="lr_sweep/14_truncated_rope"
...
echo "=========================================="
echo "Starting ASHA Sweep: 14_truncated_rope"
echo "=========================================="
