...
class TrainConfig:
    ...
    wandb_run_name: str = "9_fixed_window_sweep"
    ...
    with open(metrics_csv, "w", newline="") as f_csv:
        ...
        while True:
            ...
            writer.writerow({
                ...
                "attn_blocksize": 1024,  # Fixed window size (no warmup)
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="lr_sweep/9_fixed_window", help="Output directory")
