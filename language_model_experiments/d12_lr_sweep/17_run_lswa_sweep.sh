...
#SBATCH --job-name=sweep_17
#SBATCH --output=logs/sweep_17_%A.out
#SBATCH --error=logs/sweep_17_%A.err
...
# Configuration
# ----------------------------
PY_SCRIPT="17_lswa_sweep.py"
OUT_DIR="lr_sweep/17_lswa"
...
echo "=========================================="
echo "Starting ASHA Sweep: 17_lswa (Long-Short Window Attention)"
echo "=========================================="
