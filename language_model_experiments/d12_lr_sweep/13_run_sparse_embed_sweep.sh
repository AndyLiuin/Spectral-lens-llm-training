...
#SBATCH --job-name=sweep_13
#SBATCH --output=logs/sweep_13_%A.out
#SBATCH --error=logs/sweep_13_%A.err
...
# Configuration
# ----------------------------
PY_SCRIPT="13_sparse_embed_sweep.py"
OUT_DIR="lr_sweep/13_sparse_embed"
...
echo "=========================================="
echo "Starting ASHA Sweep: 13_sparse_embed"
echo "=========================================="
