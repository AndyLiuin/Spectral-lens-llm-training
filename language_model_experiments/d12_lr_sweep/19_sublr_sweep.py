...
class TrainConfig:
    ...
    wandb_run_name: str = "19_sublr_sweep"
...
class Muon(torch.optim.Optimizer):
    ...
    """
    def __init__(self, params, lr=0.02, momentum=0.95, weight_decay=0.0, nesterov=True,
    ...
    def step(self):
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                gg = zeropower_backend(gg, steps=steps)
...
class GPT(nn.Module):
    ...
    # -----------------------
    # Block-mask construction: Long-Short Window Attention (Gemma-2 style)
    # -----------------------
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="lr_sweep/19_sublr", help="Output directory")
    parser.add_argument("--batch_sizes", type=int, nargs="+", default=[4, 8, 16, 32], help="Batch sizes to sweep")
