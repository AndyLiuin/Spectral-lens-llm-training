...
#SBATCH --job-name=sweep_10
#SBATCH --output=logs/sweep_10_%A.out
#SBATCH --error=logs/sweep_10_%A.err
...
# Configuration
# ----------------------------
PY_SCRIPT="10_flex_window_sweep.py"
OUT_DIR="lr_sweep/10_flex_window"
...
echo "=========================================="
echo "Starting ASHA Sweep: 10_flex_window"
echo "=========================================="
