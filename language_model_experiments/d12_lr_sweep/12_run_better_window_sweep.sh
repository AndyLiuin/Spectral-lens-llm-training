...
#SBATCH --job-name=sweep_12
#SBATCH --output=logs/sweep_12_%A.out
#SBATCH --error=logs/sweep_12_%A.err
...
# Configuration
# ----------------------------
PY_SCRIPT="12_better_window_sweep.py"
OUT_DIR="lr_sweep/12_better_window"
...
echo "=========================================="
echo "Starting ASHA Sweep: 12_better_window"
echo "=========================================="
