...
class TrainConfig:
    ...
    wandb_run_name: str = "7_value_mix_sweep"
...
class GPT(nn.Module):
    ...
    def forward(self, idx, target):
        ...
        # Simple sequential pass through all blocks with value mix
...
def train_one_run(
    ...
    # No skip_weights in this model (no UNet structure)
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="lr_sweep/7_value_mix", help="Output directory")
