...
#SBATCH --job-name=sweep_15
#SBATCH --output=logs/sweep_15_%A.out
#SBATCH --error=logs/sweep_15_%A.err
...
# Configuration
# ----------------------------
PY_SCRIPT="15_softcap_sweep.py"
OUT_DIR="lr_sweep/15_softcap"
...
echo "=========================================="
echo "Starting ASHA Sweep: 15_softcap"
echo "=========================================="
