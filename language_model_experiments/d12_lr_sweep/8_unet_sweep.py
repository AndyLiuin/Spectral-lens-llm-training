...
class TrainConfig:
    ...
    wandb_run_name: str = "8_unet_sweep"
...
class GPT(nn.Module):
    ...
    def forward(self, idx, target):
        ...
        for i in range(self.num_decoder_layers):
            ...
            x, v1 = self.transformer.h[self.num_encoder_layers + i](x + weighted_skip, v1, x0)
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="lr_sweep/8_unet", help="Output directory")
