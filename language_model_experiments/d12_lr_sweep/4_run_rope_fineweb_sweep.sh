...
#SBATCH --job-name=sweep_04
#SBATCH --output=logs/sweep_04_%A.out
#SBATCH --error=logs/sweep_04_%A.err
...
# Configuration
# ----------------------------
PY_SCRIPT="4_rope_fineweb_sweep.py"
OUT_DIR="lr_sweep/4_rope"
...
echo "=========================================="
echo "Starting ASHA Sweep: 4_rope_fineweb (RoPE, Single AdamW)"
echo "=========================================="
