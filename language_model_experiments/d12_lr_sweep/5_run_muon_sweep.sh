...
#SBATCH --job-name=sweep_05
#SBATCH --output=logs/sweep_05_%A.out
#SBATCH --error=logs/sweep_05_%A.err
...
# Configuration
# ----------------------------
PY_SCRIPT="5_muon_sweep.py"
OUT_DIR="lr_sweep/5_muon"
...
echo "=========================================="
echo "Starting ASHA Sweep: 5_muon (Tied Embeddings, Muon Opt)"
echo "=========================================="
