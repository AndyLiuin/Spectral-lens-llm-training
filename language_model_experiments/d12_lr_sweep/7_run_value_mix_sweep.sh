...
#SBATCH --job-name=sweep_07
#SBATCH --output=logs/sweep_07_%A.out
#SBATCH --error=logs/sweep_07_%A.err
...
# Configuration
# ----------------------------
PY_SCRIPT="7_value_mix_sweep.py"
OUT_DIR="lr_sweep/7_value_mix"
...
echo "=========================================="
echo "Starting ASHA Sweep: 7_value_mix (Value Mix without UNet)"
echo "=========================================="
