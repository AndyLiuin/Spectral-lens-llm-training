...
class TrainConfig:
    ...
    # Optimizer LRs (3-way for untied embeddings)
    embed_lr: float = 0.3
    head_lr: float = 0.002
    muon_lr: float = 0.02
    muon_momentum: float = 0.95  # Fixed momentum (no warmup in 6_untie_embed)
    ...
    wandb_run_name: str = "6_untie_embed_sweep"
...
def train_one_run(
    ...
    # optimizers (use raw_model, not compiled model) - 3 optimizers for untied embed
    ...
    optimizers = [opt_embed, opt_head, opt_muon]
    ...
    with open(metrics_csv, "w", newline="") as f_csv:
        fieldnames = [
            ...
            "lr_embed","lr_head","lr_muon","muon_momentum",
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="lr_sweep/6_untie_embed", help="Output directory")
    ...
    with TeeLogger(log_path):
        ...
        try:
            ...
            cols = [
                ...
                "embed_lr", "head_lr", "muon_lr", "run_dir"
            ]
