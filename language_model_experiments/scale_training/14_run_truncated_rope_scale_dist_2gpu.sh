...
#SBATCH --job-name=train14_dist2g
#SBATCH --output=logs/train14_dist2g_%A.out
#SBATCH --error=logs/train14_dist2g_%A.err
...
OUT_DIR="${OUT_DIR:-${SCRATCH_ROOT}/data_fineweb_const_loss_dist/14_truncated_rope_${MODEL_PROFILE}_dist2g}"
PY_SCRIPT="${SCRIPT_DIR}/14_truncated_rope_scale_dist.py"
