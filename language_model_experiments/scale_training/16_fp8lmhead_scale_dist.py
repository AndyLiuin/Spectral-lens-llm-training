...
# We'll conditionally compile flex_attention later based on args.compile_enabled.
...
def main():
    ...
    # Do NOT compile it again here. Only compile the whole model if args.compile_enabled.
