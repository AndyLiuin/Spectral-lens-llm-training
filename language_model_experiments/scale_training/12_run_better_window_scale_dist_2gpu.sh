...
#SBATCH --job-name=train12_dist2g
#SBATCH --output=logs/train12_dist2g_%A.out
#SBATCH --error=logs/train12_dist2g_%A.err
...
OUT_DIR="${OUT_DIR:-${SCRATCH_ROOT}/data_fineweb_const_loss_dist/12_better_window_${MODEL_PROFILE}_dist2g}"
PY_SCRIPT="${SCRIPT_DIR}/12_better_window_scale_dist.py"
