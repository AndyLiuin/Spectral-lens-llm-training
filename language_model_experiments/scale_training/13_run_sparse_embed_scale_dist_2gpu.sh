...
#SBATCH --job-name=train13_dist2g
#SBATCH --output=logs/train13_dist2g_%A.out
#SBATCH --error=logs/train13_dist2g_%A.err
...
OUT_DIR="${OUT_DIR:-${SCRATCH_ROOT}/data_fineweb_const_loss_dist/13_sparse_embed_${MODEL_PROFILE}_dist2g}"
PY_SCRIPT="${SCRIPT_DIR}/13_sparse_embed_scale_dist.py"
