...
#SBATCH --job-name=train15_dist2g
#SBATCH --output=logs/train15_dist2g_%A.out
#SBATCH --error=logs/train15_dist2g_%A.err
...
OUT_DIR="${OUT_DIR:-${SCRATCH_ROOT}/data_fineweb_const_loss_dist/15_softcap_${MODEL_PROFILE}_dist2g}"
PY_SCRIPT="${SCRIPT_DIR}/15_softcap_scale_dist.py"
