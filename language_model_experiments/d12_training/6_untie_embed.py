...
from typing import Tuple, Optional, Literal  # Added missing type hints
...
def parse_args():
    parser = argparse.ArgumentParser(description="GPT-2 training with untied embeddings and Muon optimizer")
...
def main():
    ...
    print0(f"\n{'='*60}")
    print0("CONFIGURATION: UNTIED EMBEDDINGS (6_untie_embed)")
    print0(f"{'='*60}")
    ...
    def lr_mult(step_idx):
        """LR multiplier matching 4_untie_embed.py exactly."""
        s = int(step_idx)
