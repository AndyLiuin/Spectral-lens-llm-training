...
#SBATCH --job-name=gpt2_17_lswa_adam
#SBATCH --output=logs/17_lswa_adam_%A.out
#SBATCH --error=logs/17_lswa_adam_%A.err
...
# Output directory
OUT_DIR="data_fineweb_const_loss/17_lswa_adam_gpt2"
...
WANDB_RUN_NAME="17_lswa_adam_gpt2"
WANDB_MODE="online"
...
# ----------------------------
echo "=========================================="
echo "Starting 1-GPU Training: LSWA Adam Variant"
echo "=========================================="
echo "Script: ${PY_SCRIPT}"
echo "Output: ${OUT_DIR}"
echo ""
echo "Architecture: VTE + Local Sliding Window Attention"
echo "Optimizer Split: Adam embed/head/matrix/scalar"
