...
#SBATCH --job-name=sparse_embed_1gpu
#SBATCH --output=logs/sparse_embed_%A.out
#SBATCH --error=logs/sparse_embed_%A.err
...
# Output directory
OUT_DIR="data_fineweb_const_loss/13_sparse_embed_gpt2"
...
BATCH_SIZE=8                    # Global batch size (sequences) => 8 * 65536 = 524k tokens
DEVICE_BATCH_SIZE=1             # Sequences per GPU (must be 1 for flex attention)
SEQ_LEN=65536                   # 64K tokens per sequence
...
WANDB_RUN_NAME="13_sparse_embed_gpt2"
WANDB_MODE="online"
...
# ----------------------------
echo "=========================================="
echo "Starting 1-GPU Training: Sparse Embeddings Architecture"
echo "=========================================="
echo "Script: ${PY_SCRIPT}"
echo "Output: ${OUT_DIR}"
echo ""
echo "Architecture: Sparse VTE + Flex Window Attention (${WINDOW_MIN} -> ${WINDOW_MAX})"
