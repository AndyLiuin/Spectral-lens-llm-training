...
#SBATCH --job-name=gpt2_19_sublr
#SBATCH --output=logs/19_sublr_%A.out
#SBATCH --error=logs/19_sublr_%A.err
...
# Output directory
OUT_DIR="data_fineweb_const_loss/19_sublr_gpt2"
...
# ----------------------------
echo "=========================================="
echo "Starting 1-GPU Training: SubLR Architecture"
echo "=========================================="
echo "Script: ${PY_SCRIPT}"
echo "Output: ${OUT_DIR}"
echo ""
echo "Architecture: VTE + Flex Window Attention + SubLR"
