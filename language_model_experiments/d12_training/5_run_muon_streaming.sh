...
#SBATCH --job-name=gpt2_5_muon_streaming
#SBATCH --output=logs/5_muon_streaming_%A.out
#SBATCH --error=logs/5_muon_streaming_%A.err
...
# Output directory
OUT_DIR="/nfs/roberts/scratch/pi_jks79/zl664/Scaling_final/const_loss_run_gpt2s/5_muon_streaming_gpt2/bs524288_muonlr0.00036"
...
# ----------------------------
echo "==========================================="
echo "Starting 1-GPU Training: Muon Optimizer (Streaming)"
echo "==========================================="
...
echo ""
echo "Optimizer: AdamW (embed_lr=${EMBED_LR}) + Muon (muon_lr=${MUON_LR}, momentum=${MUON_MOMENTUM})"
echo "==========================================="
echo ""
