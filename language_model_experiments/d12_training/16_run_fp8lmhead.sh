...
#SBATCH --job-name=gpt2_16_fp8lmhead
#SBATCH --output=logs/16_fp8lmhead_%A.out
#SBATCH --error=logs/16_fp8lmhead_%A.err
...
# Output directory
OUT_DIR="data_fineweb_const_loss/16_fp8lmhead_gpt2"
...
WANDB_RUN_NAME="16_fp8lmhead_gpt2"
WANDB_MODE="online"
...
# ----------------------------
echo "=========================================="
echo "Starting 1-GPU Training: FP8 LM Head Architecture"
echo "=========================================="
echo "Script: ${PY_SCRIPT}"
echo "Output: ${OUT_DIR}"
echo ""
echo "Architecture: VTE + Flex Window Attention + FP8 LM Head"
