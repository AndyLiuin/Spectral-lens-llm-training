...
#SBATCH --job-name=gpt2_15_softcap
#SBATCH --output=logs/15_softcap_%A.out
#SBATCH --error=logs/15_softcap_%A.err
...
# Output directory
OUT_DIR="data_fineweb_const_loss/15_softcap_gpt2"
...
WANDB_RUN_NAME="15_softcap_gpt2"
WANDB_MODE="online"
...
# ----------------------------
echo "=========================================="
echo "Starting 1-GPU Training: Softcap Architecture"
echo "=========================================="
echo "Script: ${PY_SCRIPT}"
echo "Output: ${OUT_DIR}"
echo ""
echo "Architecture: VTE + Flex Window Attention + Softcap"
