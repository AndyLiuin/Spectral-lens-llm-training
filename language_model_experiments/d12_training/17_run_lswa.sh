...
#SBATCH --job-name=gpt2_17_lswa
#SBATCH --output=logs/17_lswa_%A.out
#SBATCH --error=logs/17_lswa_%A.err
...
# Output directory
OUT_DIR="data_fineweb_const_loss/17_lswa_gpt2"
...
# ----------------------------
echo "=========================================="
echo "Starting 1-GPU Training: LSWA Architecture"
echo "=========================================="
