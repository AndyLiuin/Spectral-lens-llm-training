...
#SBATCH --job-name=sweep12_dist2g
#SBATCH --output=/nfs/roberts/scratch/pi_jks79/zl664/Scaling_final/gpt2_scale/logs/sweep12_dist2g_%j.out
#SBATCH --error=/nfs/roberts/scratch/pi_jks79/zl664/Scaling_final/gpt2_scale/logs/sweep12_dist2g_%j.err
...
OUT_DIR="${OUT_DIR:-${SCRATCH_ROOT}/lr_sweep_dist/12_better_window_${MODEL_PROFILE}_dist2g}"
RUNGS="${RUNGS:-40000000 70000000 100000000}"
ETA="${ETA:-3}"
EXTRAP_TARGET="${EXTRAP_TARGET:-1000000000}"
PY_SCRIPT="${SCRIPT_DIR}/12_better_window_scale_dist_sweep.py"
