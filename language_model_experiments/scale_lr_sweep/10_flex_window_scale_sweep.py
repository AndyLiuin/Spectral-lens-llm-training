...
class TrainConfig:
    ...
    wandb_run_name: str = "10_flex_window_sweep"
...
class GPT(nn.Module):
    ...
    def forward(self, idx, target, attn_blocksize):
        ...
        # 10_flex_window uses create_block_mask dynamically
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="lr_sweep/10_flex_window", help="Output directory")
