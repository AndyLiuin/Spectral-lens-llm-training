...
class TrainConfig:
    ...
    wandb_run_name: str = "13_sparse_embed_sweep"
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="lr_sweep/13_sparse_embed", help="Output directory")
