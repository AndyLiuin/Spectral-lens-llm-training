...
#SBATCH --job-name=sweep13_dist2g
#SBATCH --output=logs/sweep13_dist2g_%A.out
#SBATCH --error=logs/sweep13_dist2g_%A.err
...
OUT_DIR="${OUT_DIR:-${SCRATCH_ROOT}/lr_sweep_dist/13_sparse_embed_${MODEL_PROFILE}_dist2g}"
RUNGS="${RUNGS:-40000000 70000000 100000000}"
ETA="${ETA:-3}"
EXTRAP_TARGET="${EXTRAP_TARGET:-1000000000}"
PY_SCRIPT="${SCRIPT_DIR}/13_sparse_embed_scale_dist_sweep.py"
