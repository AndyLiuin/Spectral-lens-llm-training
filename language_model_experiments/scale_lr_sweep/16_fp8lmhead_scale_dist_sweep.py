...
class TrainConfig:
    ...
    wandb_run_name: str = "16_fp8lmhead_sweep"
...
def train_one_run(
    ...
    opt_ve_params = list(raw_model.value_embeds.parameters())
    opt_block_params = list(raw_model.transformer.h.parameters())
    opt_wte_weight = raw_model.transformer.wte.weight
    opt_lm_head_weight = raw_model.lm_head.weight
    opt_skip_weights = raw_model.skip_weights
    ...
    scalar_params = list(opt_scalar_params)
    scalar_params.append(opt_skip_weights)
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="lr_sweep/16_fp8lmhead", help="Output directory")
